...
public class Sorter {
	...
	/**
	 * An instance of ComparatorFactory, which be used to get Comparator implements.
	 */
	 ...
	 * @param propertyClass the Class that need to be used to compare in an object property
	 * @param beanComparatorClass a Class of BeanComparator
	 */
	public void registerBeanComparator(Class propertyClass, Class beanComparatorClass) {
	 ...
	 * </p>
	 * to use an instance of MyStringComparator to sort the String type property.
	 * @param propertyClass the Class that need to be compare
	 * @param comparator an instance of BeanComparator
	 * @deprecated use registerBeanComparator(Class propertyClass, Class beanComparatorClass) to replace
	 */
	public void registerBeanComparator(Class propertyClass, BeanComparator comparator) {
	...
	private <T> void sort(List<T> list, BeanComparator beanComparator, SortOrder sortOrder) {
	 ...
	 * <li>Get comparator from registered instance of BeanComparator.</li>
	 * <li>Get comparator from registered Class of BeanComparator.</li>
	 * <li>Get comparator from definition in comparator.properties.</li>
	 * @param <T>
	...
	private <T> BeanComparator getBeanComparator(Class clazz, String property) {
		...
		if( comparators.containsKey(fieldType) ) {
			...
			try {
		        String className = beanComparatorClasses.get(fieldType).getName();
